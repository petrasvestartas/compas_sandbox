...
def test_cra_snake():
    ...
    assembly = compas.json_load(os.path.join(compas_sandbox.SAMPLE, "snake.json")).copy(cls=CRA_Assembly)
    assembly.set_boundary_conditions([0])
...
def test_cra_arch_has_iteration_headroom():
    ...
    from compas_sandbox.equilibrium.cra_native import _CRA_OPTIONS
    from compas_sandbox.nlp import solve_nlp
